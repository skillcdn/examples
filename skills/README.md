...
|---|---|---|
| [`higgsfield-shorts-ad/`](higgsfield-shorts-ad/) | Higgsfield | A vertical short-form AI ad in the style of a reference video, from just the reference and a product link. Derive the rest, plan, approve generated cast portraits and a first frame per shot, confirm a recommended model with its credit estimate, animate one draft take at a time, edit and caption in code. |
